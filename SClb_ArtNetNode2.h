...
#ifndef _SClb_ArtNetNode2_h
#define _SClb_ArtNetNode2_h
...
class SCArtNet2 : public SClb_Arduino_DMXEthernet {
...
public:
	...
	*/
	SCArtNet2(IPAddress address, IPAddress subnet_mask, uint8_t* buffer);


	/*!
	* @brief destructor for SCArtNet2 (frees packet buffer if allocated with constructor)
	*/
	~SCArtNet2(void);
...
#endif // ifndef SClb_ArtNetNode2_H
